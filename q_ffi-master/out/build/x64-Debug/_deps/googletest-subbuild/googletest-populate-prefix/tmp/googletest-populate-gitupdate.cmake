...
execute_process(
  COMMAND "D:/Program Files/Git/cmd/git.exe" show-ref "release-1.10.0"
  WORKING_DIRECTORY "E:/q_ffi-master/q_ffi-master/out/build/x64-Debug/_deps/googletest-src"
...
# yet).
execute_process(
  COMMAND "D:/Program Files/Git/cmd/git.exe" rev-list --max-count=1 "${git_tag}"
  WORKING_DIRECTORY "E:/q_ffi-master/q_ffi-master/out/build/x64-Debug/_deps/googletest-src"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      execute_process(
        COMMAND "D:/Program Files/Git/cmd/git.exe" checkout "${git_remote}/${git_tag}"
        WORKING_DIRECTORY "E:/q_ffi-master/q_ffi-master/out/build/x64-Debug/_deps/googletest-src"
        RESULT_VARIABLE error_code
        )
      if(error_code)
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: 'E:/q_ffi-master/q_ffi-master/out/build/x64-Debug/_deps/googletest-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'E:/q_ffi-master/q_ffi-master/out/build/x64-Debug/_deps/googletest-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
    ...
    execute_process(
      COMMAND "D:/Program Files/Git/cmd/git.exe" checkout "${git_tag}"
      WORKING_DIRECTORY "E:/q_ffi-master/q_ffi-master/out/build/x64-Debug/_deps/googletest-src"
      RESULT_VARIABLE error_code
      )
    if(error_code)
